...
entry:
  ...
  %cmp = fcmp olt double %0, 1.800000e+00, !dbg !243
  %1 = load double* %x.addr, align 8, !dbg !245
  br i1 %cmp, label %if.then, label %if.else, !dbg !243

if.then:                                          ; preds = %entry
  %sub = fsub double %1, 1.000000e+00, !dbg !245
  store double %sub, double* %retval, !dbg !245
  br label %return, !dbg !245

if.else:                                          ; preds = %entry
  %add = fadd double %1, 1.000000e+00, !dbg !246
  store double %add, double* %retval, !dbg !246
...
entry:
  ...
  %0 = load double* %v.addr, align 8, !dbg !248
  ret double %0, !dbg !248
}
...
entry:
  ...
  %0 = bitcast double* %a to i8*, !dbg !249
  call void @klee_make_symbolic(i8* %0, i64 8, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !dbg !249
  %1 = load double* %a, align 8, !dbg !250
  %call = call double @get_sign(double %1), !dbg !250
  store double %call, double* %res, align 8, !dbg !250
  %2 = load double* %res, align 8, !dbg !251
  %call1 = call double @klee_output(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), double %2), !dbg !251
  ret i32 0, !dbg !252
}
...
!9 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"klee_output", metadata !"klee_output", metadata !"", i32 14, metadata !10, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, double (i8*, double)* @klee_output, null, null, metadata
...
!254 = metadata !{i32 16, i32 0, metadata !26, null}
