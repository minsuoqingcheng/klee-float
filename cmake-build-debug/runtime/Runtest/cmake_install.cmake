# Install script for directory: /home/unix-lc/klee-float/runtime/Runtest
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/unix-lc/klee-float/cmake-build-debug/lib/libkleeRuntest.so.1.0")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/unix-lc/klee-float/cmake-build-debug/lib/libkleeRuntest.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so")
    if(CMAKE_INSTALL_DO_STRIP)
