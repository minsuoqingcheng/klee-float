; ModuleID = '/home/unix-lc/klee-float/runtime/Intrinsic/memcpy.c'
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %next.gep.sum282 = or i64 %index, 16, !dbg !30
  %2 = getelementptr i8* %srcaddr, i64 %next.gep.sum282, !dbg !30
  %3 = bitcast i8* %2 to <16 x i8>*, !dbg !30
  %wide.load203 = load <16 x i8>* %3, align 1, !dbg !30
  %4 = bitcast i8* %next.gep106 to <16 x i8>*, !dbg !30
  store <16 x i8> %wide.load, <16 x i8>* %4, align 1, !dbg !30
  %next.gep106.sum299 = or i64 %index, 16, !dbg !30
  %5 = getelementptr i8* %destaddr, i64 %next.gep106.sum299, !dbg !30
  %6 = bitcast i8* %5 to <16 x i8>*, !dbg !30
  store <16 x i8> %wide.load203, <16 x i8>* %6, align 1, !dbg !30
...
while.body:                                       ; preds = %middle.block, %while.body
  ...
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr1}, i64 0, metadata !17), !dbg !30
  store i8 %8, i8* %dest.05, align 1, !dbg !30, !tbaa !34
  tail call void @llvm.dbg.value(metadata !{i64 %dec}, i64 0, metadata !16), !dbg !29
  %cmp = icmp eq i64 %dec, 0, !dbg !29
  br i1 %cmp, label %while.end, label %while.body, !dbg !29, !llvm.loop !37
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/unix-lc/klee-float/cmake-build-debug/runtime/Intrinsic//home/unix-lc/klee-float/runtime/Intrinsic/memcpy.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/unix-lc/klee-float/runtime/Intrinsic/memcpy.c", metadata !"/home/unix-lc/klee-float/cmake-build-debug/runtime/Intrinsic"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/unix-lc/klee-float/cmake-build-debug/runtime/Intrinsic//home/unix-lc/klee-float/runtime/Intrinsic/memcpy.c]
