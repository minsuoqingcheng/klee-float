; ModuleID = '/home/unix-lc/klee-float/runtime/klee-libc/htonl.c'
...
entry:
  ...
  %or = tail call i16 @llvm.bswap.i16(i16 %v), !dbg !29
  ret i16 %or, !dbg !29
}
...
entry:
  ...
  %shr = lshr i32 %v, 16, !dbg !31
  %conv = trunc i32 %shr to i16, !dbg !31
  tail call void @llvm.dbg.value(metadata !{i16 %conv}, i64 0, metadata !32) #2, !dbg !33
  %or.i = tail call i16 @llvm.bswap.i16(i16 %conv) #2, !dbg !34
  %conv1 = zext i16 %or.i to i32, !dbg !31
  %conv2 = trunc i32 %v to i16, !dbg !31
  tail call void @llvm.dbg.value(metadata !{i16 %conv2}, i64 0, metadata !32) #2, !dbg !33
  %or.i6 = tail call i16 @llvm.bswap.i16(i16 %conv2) #2, !dbg !34
  %conv4 = zext i16 %or.i6 to i32, !dbg !31
  %shl = shl nuw i32 %conv4, 16, !dbg !31
  %or = or i32 %shl, %conv1, !dbg !31
  ret i32 %or, !dbg !31
}
...
entry:
  ...
  %or.i = tail call i16 @llvm.bswap.i16(i16 %v) #2, !dbg !39
  ret i16 %or.i, !dbg !37
}
...
entry:
  ...
  %shr.i = lshr i32 %v, 16, !dbg !44
  %conv.i = trunc i32 %shr.i to i16, !dbg !44
  tail call void @llvm.dbg.value(metadata !{i16 %conv.i}, i64 0, metadata !45) #2, !dbg !46
  %or.i.i = tail call i16 @llvm.bswap.i16(i16 %conv.i) #2, !dbg !47
  %conv1.i = zext i16 %or.i.i to i32, !dbg !44
  %conv2.i = trunc i32 %v to i16, !dbg !44
  tail call void @llvm.dbg.value(metadata !{i16 %conv2.i}, i64 0, metadata !45) #2, !dbg !46
  %or.i6.i = tail call i16 @llvm.bswap.i16(i16 %conv2.i) #2, !dbg !47
  %conv4.i = zext i16 %or.i6.i to i32, !dbg !44
  %shl.i = shl nuw i32 %conv4.i, 16, !dbg !44
  %or.i = or i32 %shl.i, %conv1.i, !dbg !44
  ret i32 %or.i, !dbg !42
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/unix-lc/klee-float/cmake-build-debug/runtime/klee-libc//home/unix-lc/klee-float/runtime/klee-libc/htonl.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/unix-lc/klee-float/runtime/klee-libc/htonl.c", metadata !"/home/unix-lc/klee-float/cmake-build-debug/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/unix-lc/klee-float/cmake-build-debug/runtime/klee-libc//home/unix-lc/klee-float/runtime/klee-libc/htonl.c]
