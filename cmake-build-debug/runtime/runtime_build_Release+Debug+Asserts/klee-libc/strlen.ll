; ModuleID = '/home/unix-lc/klee-float/runtime/klee-libc/strlen.c'
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %0 = load i8* %s.0, align 1, !dbg !20, !tbaa !21
  %tobool = icmp eq i8 %0, 0, !dbg !20
  %incdec.ptr = getelementptr inbounds i8* %s.0, i64 1, !dbg !24
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !14), !dbg !24
  br i1 %tobool, label %while.end, label %while.cond, !dbg !20

while.end:                                        ; preds = %while.cond
  %sub.ptr.lhs.cast = ptrtoint i8* %s.0 to i64, !dbg !25
  %sub.ptr.rhs.cast = ptrtoint i8* %str to i64, !dbg !25
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !25
  ret i64 %sub.ptr.sub, !dbg !25
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/unix-lc/klee-float/cmake-build-debug/runtime/klee-libc//home/unix-lc/klee-float/runtime/klee-libc/strlen.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/unix-lc/klee-float/runtime/klee-libc/strlen.c", metadata !"/home/unix-lc/klee-float/cmake-build-debug/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/unix-lc/klee-float/cmake-build-debug/runtime/klee-libc//home/unix-lc/klee-float/runtime/klee-libc/strlen.c]
